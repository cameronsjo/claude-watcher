...
- The synthesis prompts' character target now derives from the token budget
  instead of being hardcoded, at a chars-per-token ratio floored on the worst
  measured value rather than a general-prose average. The doc prompt asked for "under 3500 characters"
